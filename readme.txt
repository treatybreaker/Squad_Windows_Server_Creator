This script requires administrative rights to do its job correctly as it has an option to allow the Squad Server EXE through the firewall.
...
Allows the Squad Server EXE through the firewall both inbound and outbound. (If user responded Y)
